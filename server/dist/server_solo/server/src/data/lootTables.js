...
exports.LootTables = {
    normal: {
        ...
        ...obstacles_1.Obstacles.definitions.filter(def => {
        ...
        airdrop_crate: [
            ...
            [
                ...
                { item: objectDefinitions_1.NullString, weight: 1 }
            ]
        ],
        gold_airdrop_crate: [
            [{ table: "airdrop_equipment", weight: 1 }],
        ...
        jack_o_lantern: [
            ...
            [
                { item: objectDefinitions_1.NullString, weight: 1.5 },
                { item: "costumed" /* PerkIds.Costumed */, weight: 1 }
            ]
        ],
        plumpkin: {
            min: 3,
        ...
        diseased_plumpkin: [
            [{ item: "plumpkin_gamble" /* PerkIds.PlumpkinGamble */, weight: 1 }],
            [
                { item: "diseased", weight: 0.1 },
                { item: objectDefinitions_1.NullString, weight: 0.9 }
            ]
        ],
        fall_perks: {
            min: 1,
            ...
            noDuplicates: true,
            loot: [
                { item: "infinite_ammo" /* PerkIds.InfiniteAmmo */, weight: 1 },
                { item: "extended_mags" /* PerkIds.ExtendedMags */, weight: 1 },
                { item: "flechettes" /* PerkIds.Flechettes */, weight: 1 },
                { item: "demo_expert" /* PerkIds.DemoExpert */, weight: 1 },
                { item: "second_wind" /* PerkIds.SecondWind */, weight: 1 },
                { item: "field_medic" /* PerkIds.FieldMedic */, weight: 1 },
                { item: "sabot_rounds" /* PerkIds.SabotRounds */, weight: 1 },
                { item: "advanced_athletics" /* PerkIds.AdvancedAthletics */, weight: 1 },
                { item: "toploaded" /* PerkIds.Toploaded */, weight: 1 },
                { item: "close_quarters_combat" /* PerkIds.CloseQuartersCombat */, weight: 1 },
                { item: "low_profile" /* PerkIds.LowProfile */, weight: 1 },
                { item: "berserker" /* PerkIds.Berserker */, weight: 1 },
                { item: "combat_expert" /* PerkIds.CombatExpert */, weight: 1 },
                { item: "precision_recycling" /* PerkIds.PrecisionRecycling */, weight: 1 },
                { item: "loot_baron" /* PerkIds.LootBaron */, weight: 1 }
            ]
        },
        red_gift: [
            [
        ...
        black_gift: [
            [
                { item: objectDefinitions_1.NullString, weight: 0.25 },
    ...
    halloween: {
        ...
        airdrop_crate: [
            ...
            [
                ...
                { item: objectDefinitions_1.NullString, weight: 0.5 }
            ],
            [
                { item: "frag_grenade", count: 3, weight: 2 },
                { item: objectDefinitions_1.NullString, weight: 1 }
