...
exports.Vec = Object.assign(create, {
    /**
     ...
     */
    len(a) {
        return Math.sqrt(exports.Vec.squaredLen(a));
    },
    /**
    ...
    normalizeSafe(a, fallback) {
        ...
        const eps = 0.000001;
        const len = exports.Vec.len(a);
        return len > eps
            ? {
                x: a.x / len,
                y: a.y / len
            }
            : exports.Vec.clone(fallback);
    },
    /**
     * Creates a new `Vector` parallel to the original, but whose length is 1
     * @param a The `Vector` to normalize
    ...
    angleBetweenVectors(a, b) {
        return Math.acos((a.x * b.x + a.y * b.y) / Math.sqrt(exports.Vec.len(a) * exports.Vec.len(b)));
    },
    /**
    ...
    lerp(start, end, interpFactor) {
        return exports.Vec.add(exports.Vec.scale(start, 1 - interpFactor), exports.Vec.scale(end, interpFactor));
    },
    /**
    ...
    addAdjust(position1, position2, orientation) {
        if (orientation === 0)
            return exports.Vec.add(position1, position2);
        let xOffset, yOffset;
        switch (orientation) {
            case 1:
        ...
        return exports.Vec.add(position1, (0, exports.Vec)(xOffset, yOffset));
    }
});
