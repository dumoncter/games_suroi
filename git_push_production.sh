...
echo -e "${BLUE}   🌐 Запустит nginx + два Node.js сервера (solo:8082 + team:8083)${NC}"
echo -e "${BLUE}   🔌 Настроит WebSocket прокси для /solo/play и /team/play${NC}"
...
echo -e "${BLUE}   👤 Solo Battles - https://suroi.neonpsh.games/solo/play${NC}"
echo -e "${BLUE}   👥 Team Battles - https://suroi.neonpsh.games/team/play${NC}"
echo -e "${BLUE}   🌐 Production URL: https://suroi.neonpsh.games${NC}"
echo ""
