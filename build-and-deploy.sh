...
find . -not -path './.git*' -not -path './.git' -not -path './deploy.sh' -not -path './build-and-deploy.sh' -not -path './Dockerfile' -not -path './railway.toml' -not -path './nginx.conf' -not -path './.gitignore' -not -path './.dockerignore' -not -path './status.txt' -delete
