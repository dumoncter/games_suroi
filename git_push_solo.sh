...
echo -e "${BLUE}   🌐 Запустит Solo сервер на порту 8080${NC}"
...
echo ""
echo -e "${GREEN}🌐 Solo Server URL: https://suroi-solo-production.up.railway.app${NC}"
echo ""
echo -e "${BLUE}🎮 Режим игры:${NC}"
echo -e "${BLUE}   👤 Solo Battles - https://suroi-solo-production.up.railway.app/play${NC}"
echo ""
